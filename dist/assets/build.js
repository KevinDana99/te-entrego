...
`,ba=A.div`
  margin-top: 21px;
`,ob=()=>{const{currentProps:t}=Vo(),e=t.shipmentData;return console.log(e),d.jsxs(rb,{children:[d.jsxs(ua,{children:[d.jsx(ga,{children:d.jsx(eb,{})}),d.jsx(Ue,{children:"en reparto"}),d.jsxs(ba,{children:[d.jsx("b",{children:"Estado:"})," ",d.jsx(Ue,{children:" en reparto"})]}),"24-04-2024"]}),d.jsx(hi,{}),d.jsxs(ua,{children:[d.jsx(ga,{children:e.estado==="TERMINAL DESTINO"||e.estado==="ENTREGADA"||e.estado==="A RECIBIR POR COORDINADORA"||e.estado==="EN TRANSPORTE"?d.jsx(bi,{}):d.jsx(ui,{})}),d.jsx(Ue,{children:"en terminal de destino"}),d.jsxs(ba,{children:[d.jsx("b",{children:"Estado:"})," ",d.jsx(Ue,{children:" en terminal de destino"})]}),"24-04-2024"]}),d.jsx(hi,{}),d.jsxs(ua,{children:[d.jsx(ga,{children:e.estado==="EN TRANSPORTE"||e.estado==="A RECIBIR POR COORDINADORA"||e.estado==="ENTREGADA"?d.jsx(bi,{}):d.jsx(ui,{})}),d.jsx(Ue,{children:"en transporte"}),d.jsxs(ba,{children:[d.jsx("b",{children:"Estado:"})," ",d.jsx(Ue,{children:" en transporte"})]}),"24-04-2024"]}),d.jsx(hi,{}),d.jsxs(ua,{children:[d.jsx(ga,{children:e.estado==="ENTREGADA"?d.jsx(bi,{}):d.jsx(ui,{})}),d.jsx(Ue,{children:"entregado"}),d.jsx(ba,{style:{color:"#60789A"},children:"Llego tu pedido"})]})]})},ab=(t,e)=>{const r=localStorage.getItem("config"),o=r&&JSON.parse(r),a=()=>{const h=o.operator;return t.findIndex(v=>v.operator.toLowerCase()===h)};console.log({currentProps:e});const n=e.order,i=n.customer.city,[l,s]=L.useState(a()),m=h=>{s(h)},u=hl("https://te-entrego.com/teadmin_beta/public/api/ciudades",{codigocliente:o.client_code,accesoapi:o.public_key,llaveseguridad:o.secret_key,paramb:i}).data,g=()=>{var X;const h=(X=n==null?void 0:n.products)==null?void 0:X.reduce((v,k)=>(v.weight+=k.weight,k.width>v.width&&(v.width=k.width),k.height>v.height&&(v.height=k.height),k.length>v.length&&(v.length=k.length),v),{weight:0,width:0,height:0,length:0});return{weight:h==null?void 0:h.weight,width:h==null?void 0:h.width,height:h==null?void 0:h.height,length:h==null?void 0:h.length}},{height:x,length:w,weight:y,width:E}=g(),{loading:f,data:c,error:p}=hl("https://te-entrego.com/teadmin_beta/public/api/calcular_envio",{origen:u.lista[0].codigodanelargo,destino:u.lista[0].codigodanelargo,unidades:n.line_items[0].fulfillable_quantity,kilos:y,ancho:E,alto:x,largo:w,vlrdeclarado:n.total_price,vlrecaudo:n.sub_total_price,dest_flete:0,dest_comision:0,operador:o.operator,codigocliente:o.client_code,accesoapi:o.public_key,llaveseguridad:o.secret_key});return console.log(c,f,p),{selectedMethod:l,handleSelectedMethod:m}},nb=A.div`
  display: flex;
  justify-content: space-around;
  align-items: center;
