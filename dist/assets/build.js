 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(Y,C){var j=Y.length;Y.push(C);t:for(;0<j;){var R=j-1>>>1,B=Y[R];if(0<a(B,C))Y[R]=C,Y[j]=B,j=R;else break t}}function r(Y){return Y.length===0?null:Y[0]}function o(Y){if(Y.length===0)return null;var C=Y[0],j=Y.pop();if(j!==C){Y[0]=j;t:for(var R=0,B=Y.length,Re=B>>>1;R<Re;){var Bt=2*(R+1)-1,pe=Y[Bt],Xt=Bt+1,ee=Y[Xt];if(0>a(pe,j))Xt<B&&0>a(ee,pe)?(Y[R]=ee,Y[Xt]=j,R=Xt):(Y[R]=pe,Y[Bt]=j,R=Bt);else if(Xt<B&&0>a(ee,j))Y[R]=ee,Y[Xt]=j,R=Xt;else break t}}return C}function a(Y,C){var j=Y.sortIndex-C.sortIndex;return j!==0?j:Y.id-C.id}if(typeof performance=="object"&&typeof performance.now=="function"){var n=performance;t.unstable_now=function(){return n.now()}}else{var i=Date,l=i.now();t.unstable_now=function(){return i.now()-l}}var s=[],m=[],b=1,u=null,g=3,x=!1,w=!1,k=!1,E=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(Y){for(var C=r(m);C!==null;){if(C.callback===null)o(m);else if(C.startTime<=Y)o(m),C.sortIndex=C.expirationTime,e(s,C);else break;C=r(m)}}function h(Y){if(k=!1,f(Y),!w)if(r(s)!==null)w=!0,Hr(y);else{var C=r(m);C!==null&&De(h,C.startTime-Y)}}function y(Y,C){w=!1,k&&(k=!1,p(S),S=-1),x=!0;var j=g;try{for(f(C),u=r(s);u!==null&&(!(u.expirationTime>C)||Y&&!zt());){var R=u.callback;if(typeof R=="function"){u.callback=null,g=u.priorityLevel;var B=R(u.expirationTime<=C);C=t.unstable_now(),typeof B=="function"?u.callback=B:u===r(s)&&o(s),f(C)}else o(s);u=r(s)}if(u!==null)var Re=!0;else{var Bt=r(m);Bt!==null&&De(h,Bt.startTime-C),Re=!1}return Re}finally{u=null,g=j,x=!1}}var z=!1,v=null,S=-1,M=5,N=-1;function zt(){return!(t.unstable_now()-N<M)}function Le(){if(v!==null){var Y=t.unstable_now();N=Y;var C=!0;try{C=v(!0,Y)}finally{C?Te():(z=!1,v=null)}}else z=!1}var Te;if(typeof c=="function")Te=function(){c(Le)};else if(typeof MessageChannel<"u"){var Ho=new MessageChannel,Pn=Ho.port2;Ho.port1.onmessage=Le,Te=function(){Pn.postMessage(null)}}else Te=function(){E(Le,0)};function Hr(Y){v=Y,z||(z=!0,Te())}function De(Y,C){S=E(function(){Y(t.unstable_now())},C)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(Y){Y.callback=null},t.unstable_continueExecution=function(){w||x||(w=!0,Hr(y))},t.unstable_forceFrameRate=function(Y){0>Y||125<Y?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):M=0<Y?Math.floor(1e3/Y):5},t.unstable_getCurrentPriorityLevel=function(){return g},t.unstable_getFirstCallbackNode=function(){return r(s)},t.unstable_next=function(Y){switch(g){case 1:case 2:case 3:var C=3;break;default:C=g}var j=g;g=C;try{return Y()}finally{g=j}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(Y,C){switch(Y){case 1:case 2:case 3:case 4:case 5:break;default:Y=3}var j=g;g=Y;try{return C()}finally{g=j}},t.unstable_scheduleCallback=function(Y,C,j){var R=t.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?R+j:R):j=R,Y){case 1:var B=-1;break;case 2:B=250;break;case 5:B=1073741823;break;case 4:B=1e4;break;default:B=5e3}return B=j+B,Y={id:b++,callback:C,priorityLevel:Y,startTime:j,expirationTime:B,sortIndex:-1},j>R?(Y.sortIndex=j,e(m,Y),r(s)===null&&Y===r(m)&&(k?(p(S),S=-1):k=!0,De(h,j-R))):(Y.sortIndex=B,e(s,Y),w||x||(w=!0,Hr(y))),Y},t.unstable_shouldYield=zt,t.unstable_wrapCallback=function(Y){var C=g;return function(){var j=g;g=C;try{return Y.apply(this,arguments)}finally{g=j}}}})(fd);md.exports=fd;var df=md.exports;/**
 * @license React
...
`,ba=A.div`
  margin-top: 21px;
`,ob=()=>{const{currentProps:t}=Vo(),e=t.shipmentData;return console.log(e),d.jsxs(rb,{children:[d.jsxs(ua,{children:[d.jsx(ga,{children:d.jsx(eb,{})}),d.jsx(Ue,{children:"en reparto"}),d.jsxs(ba,{children:[d.jsx("b",{children:"Estado:"})," ",d.jsx(Ue,{children:" en reparto"})]}),"24-04-2024"]}),d.jsx(hi,{}),d.jsxs(ua,{children:[d.jsx(ga,{children:e.estado==="TERMINAL DESTINO"||e.estado==="ENTREGADA"||e.estado==="A RECIBIR POR COORDINADORA"||e.estado==="EN TRANSPORTE"?d.jsx(bi,{}):d.jsx(ui,{})}),d.jsx(Ue,{children:"en terminal de destino"}),d.jsxs(ba,{children:[d.jsx("b",{children:"Estado:"})," ",d.jsx(Ue,{children:" en terminal de destino"})]}),"24-04-2024"]}),d.jsx(hi,{}),d.jsxs(ua,{children:[d.jsx(ga,{children:e.estado==="EN TRANSPORTE"||e.estado==="A RECIBIR POR COORDINADORA"||e.estado==="ENTREGADA"?d.jsx(bi,{}):d.jsx(ui,{})}),d.jsx(Ue,{children:"en transporte"}),d.jsxs(ba,{children:[d.jsx("b",{children:"Estado:"})," ",d.jsx(Ue,{children:" en transporte"})]}),"24-04-2024"]}),d.jsx(hi,{}),d.jsxs(ua,{children:[d.jsx(ga,{children:e.estado==="ENTREGADA"?d.jsx(bi,{}):d.jsx(ui,{})}),d.jsx(Ue,{children:"entregado"}),d.jsx(ba,{style:{color:"#60789A"},children:"Llego tu pedido"})]})]})},ab=(t,e)=>{const r=localStorage.getItem("config"),o=r&&JSON.parse(r),a=()=>{const f=o.operator;return t.findIndex(y=>y.operator.toLowerCase()===f)},n=e.order,i=n.customer.city,[l,s]=L.useState(a()),m=f=>{s(f)},b=hl("https://te-entrego.com/teadmin_beta/public/api/ciudades",{codigocliente:o.client_code,accesoapi:o.public_key,llaveseguridad:o.secret_key,paramb:i}),u=hl("https://te-entrego.com/teadmin_beta/public/api/ciudades",{codigocliente:o.client_code,accesoapi:o.public_key,llaveseguridad:o.secret_key,paramb:i}),g=b.data,x=u.data,w=()=>{var h;const f=(h=n==null?void 0:n.products)==null?void 0:h.reduce((y,z)=>(y.weight+=z.weight,z.width>y.width&&(y.width=z.width),z.height>y.height&&(y.height=z.height),z.length>y.length&&(y.length=z.length),y),{weight:0,width:0,height:0,length:0});return{weight:f==null?void 0:f.weight,width:f==null?void 0:f.width,height:f==null?void 0:f.height,length:f==null?void 0:f.length}},{height:k,length:E,weight:p,width:c}=w();return L.useEffect(()=>{g&&x&&console.log({originLocation:g,destinationLocation:x,order:n,height:k,length:E,weight:p,width:c})},[g,x]),{selectedMethod:l,handleSelectedMethod:m}},nb=A.div`
  display: flex;
  justify-content: space-around;
  align-items: center;
`,ib=({headers:t,data:e})=>{const{navigate:r,currentProps:o}=Vo(),{handleSelectedMethod:a,selectedMethod:n}=ab(e,o);return d.jsxs(d.Fragment,{children:[d.jsxs(ks,{children:[d.jsx(ys,{children:" "}),d.jsxs(vs,{children:[d.jsx(zs,{children:d.jsx("tr",{children:t.map(i=>d.jsx(On,{children:i}))})}),d.jsx(Xs,{children:e==null?void 0:e.map((i,l)=>{const s=l%2==0;return d.jsx(d.Fragment,{children:d.jsxs("tr",{children:[d.jsx(H,{active:s,children:d.jsx(nb,{children:i.img?d.jsx("img",{width:100,src:i.img}):d.jsx(Nn,{})})}),d.jsx(H,{active:s,children:i==null?void 0:i.price}),d.jsx(H,{active:s,children:l===n?d.jsx("button",{style:{margin:3,background:"#ffffff",color:"#59b6e7",border:"2px solid #59b6e7",outline:"none"},children:"Seleccionado"}):d.jsx("button",{style:{margin:3,background:"#59b6e7",outline:"none"},onClick:()=>a(l),children:"Seleccionar"})})]})})})})]})]}),d.jsx("button",{style:{alignSelf:"flex-end",marginTop:40,background:"#59b6e7",outline:"none"},onClick:()=>{confirm("¿Estas segur@ que deseas confirmar este envio?")?r("shipments"):console.log("no send")},children:"Generar envio"})]})},lb=[{operator:"Te-Entrego",price:"432432",time:"1",img:null},{operator:"Coordinadora",price:"432432",time:"2",img:"./assets/coordinadora.png"},{operator:"TCC",price:"34243",time:"2",img:"./assets/tcc.png"},{operator:"Envia",price:"423243",time:"2",img:"./assets/envia.png"}],sb=()=>d.jsx(ib,{data:lb,headers:["Operador","Cotizacion","Operacion"]}),db=({shopName:t})=>{const{path:e,shipmentData:r}=tb();return d.jsxs(Vu,{children:[d.jsx(Gu,{children:e}),d.jsx(wu,{children:d.jsx(Nn,{size:121})}),d.jsxs(ug,{children:[d.jsx(oo,{path:"orders",children:d.jsx(Uu,{shopName:t})}),d.jsx(oo,{path:"shipments",children:d.jsx(Qu,{shipmentData:r})}),d.jsx(oo,{path:"shipment-method",children:d.jsx(sb,{})}),d.jsx(oo,{path:"shipment-status",children:d.jsx(ob,{})}),d.jsx(oo,{path:"config",children:d.jsx(Ju,{})})]})]})},cb=A.div`
  display: flex;
  width: 100%;
  height: 100vh;
