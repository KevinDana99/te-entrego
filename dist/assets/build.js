 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(_,C){var j=_.length;_.push(C);t:for(;0<j;){var R=j-1>>>1,B=_[R];if(0<a(B,C))_[R]=C,_[j]=B,j=R;else break t}}function r(_){return _.length===0?null:_[0]}function o(_){if(_.length===0)return null;var C=_[0],j=_.pop();if(j!==C){_[0]=j;t:for(var R=0,B=_.length,Re=B>>>1;R<Re;){var Bt=2*(R+1)-1,pe=_[Bt],Xt=Bt+1,ee=_[Xt];if(0>a(pe,j))Xt<B&&0>a(ee,pe)?(_[R]=ee,_[Xt]=j,R=Xt):(_[R]=pe,_[Bt]=j,R=Bt);else if(Xt<B&&0>a(ee,j))_[R]=ee,_[Xt]=j,R=Xt;else break t}}return C}function a(_,C){var j=_.sortIndex-C.sortIndex;return j!==0?j:_.id-C.id}if(typeof performance=="object"&&typeof performance.now=="function"){var n=performance;t.unstable_now=function(){return n.now()}}else{var i=Date,l=i.now();t.unstable_now=function(){return i.now()-l}}var s=[],m=[],b=1,u=null,g=3,h=!1,k=!1,v=!1,E=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(_){for(var C=r(m);C!==null;){if(C.callback===null)o(m);else if(C.startTime<=_)o(m),C.sortIndex=C.expirationTime,e(s,C);else break;C=r(m)}}function x(_){if(v=!1,p(_),!k)if(r(s)!==null)k=!0,Hr(y);else{var C=r(m);C!==null&&De(x,C.startTime-_)}}function y(_,C){k=!1,v&&(v=!1,f(Y),Y=-1),h=!0;var j=g;try{for(p(C),u=r(s);u!==null&&(!(u.expirationTime>C)||_&&!zt());){var R=u.callback;if(typeof R=="function"){u.callback=null,g=u.priorityLevel;var B=R(u.expirationTime<=C);C=t.unstable_now(),typeof B=="function"?u.callback=B:u===r(s)&&o(s),p(C)}else o(s);u=r(s)}if(u!==null)var Re=!0;else{var Bt=r(m);Bt!==null&&De(x,Bt.startTime-C),Re=!1}return Re}finally{u=null,g=j,h=!1}}var X=!1,w=null,Y=-1,M=5,O=-1;function zt(){return!(t.unstable_now()-O<M)}function Le(){if(w!==null){var _=t.unstable_now();O=_;var C=!0;try{C=w(!0,_)}finally{C?Te():(X=!1,w=null)}}else X=!1}var Te;if(typeof c=="function")Te=function(){c(Le)};else if(typeof MessageChannel<"u"){var Ho=new MessageChannel,Pn=Ho.port2;Ho.port1.onmessage=Le,Te=function(){Pn.postMessage(null)}}else Te=function(){E(Le,0)};function Hr(_){w=_,X||(X=!0,Te())}function De(_,C){Y=E(function(){_(t.unstable_now())},C)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(_){_.callback=null},t.unstable_continueExecution=function(){k||h||(k=!0,Hr(y))},t.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):M=0<_?Math.floor(1e3/_):5},t.unstable_getCurrentPriorityLevel=function(){return g},t.unstable_getFirstCallbackNode=function(){return r(s)},t.unstable_next=function(_){switch(g){case 1:case 2:case 3:var C=3;break;default:C=g}var j=g;g=C;try{return _()}finally{g=j}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(_,C){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var j=g;g=_;try{return C()}finally{g=j}},t.unstable_scheduleCallback=function(_,C,j){var R=t.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?R+j:R):j=R,_){case 1:var B=-1;break;case 2:B=250;break;case 5:B=1073741823;break;case 4:B=1e4;break;default:B=5e3}return B=j+B,_={id:b++,callback:C,priorityLevel:_,startTime:j,expirationTime:B,sortIndex:-1},j>R?(_.sortIndex=j,e(m,_),r(s)===null&&_===r(m)&&(v?(f(Y),Y=-1):v=!0,De(x,j-R))):(_.sortIndex=B,e(s,_),k||h||(k=!0,Hr(y))),_},t.unstable_shouldYield=zt,t.unstable_wrapCallback=function(_){var C=g;return function(){var j=g;g=C;try{return _.apply(this,arguments)}finally{g=j}}}})(fd);md.exports=fd;var df=md.exports;/**
 * @license React
