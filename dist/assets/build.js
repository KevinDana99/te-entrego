...
`,ba=A.div`
  margin-top: 21px;
`,ob=()=>{const{currentProps:t}=Vo(),e=t.shipmentData;return console.log(e),d.jsxs(rb,{children:[d.jsxs(ua,{children:[d.jsx(ga,{children:d.jsx(eb,{})}),d.jsx(Ue,{children:"en reparto"}),d.jsxs(ba,{children:[d.jsx("b",{children:"Estado:"})," ",d.jsx(Ue,{children:" en reparto"})]}),"24-04-2024"]}),d.jsx(hi,{}),d.jsxs(ua,{children:[d.jsx(ga,{children:e.estado==="TERMINAL DESTINO"||e.estado==="ENTREGADA"||e.estado==="A RECIBIR POR COORDINADORA"||e.estado==="EN TRANSPORTE"?d.jsx(bi,{}):d.jsx(ui,{})}),d.jsx(Ue,{children:"en terminal de destino"}),d.jsxs(ba,{children:[d.jsx("b",{children:"Estado:"})," ",d.jsx(Ue,{children:" en terminal de destino"})]}),"24-04-2024"]}),d.jsx(hi,{}),d.jsxs(ua,{children:[d.jsx(ga,{children:e.estado==="EN TRANSPORTE"||e.estado==="A RECIBIR POR COORDINADORA"||e.estado==="ENTREGADA"?d.jsx(bi,{}):d.jsx(ui,{})}),d.jsx(Ue,{children:"en transporte"}),d.jsxs(ba,{children:[d.jsx("b",{children:"Estado:"})," ",d.jsx(Ue,{children:" en transporte"})]}),"24-04-2024"]}),d.jsx(hi,{}),d.jsxs(ua,{children:[d.jsx(ga,{children:e.estado==="ENTREGADA"?d.jsx(bi,{}):d.jsx(ui,{})}),d.jsx(Ue,{children:"entregado"}),d.jsx(ba,{style:{color:"#60789A"},children:"Llego tu pedido"})]})]})},ab=(t,e)=>{const r=localStorage.getItem("config"),o=r&&JSON.parse(r),a=()=>{const y=o.operator;return t.findIndex(k=>k.operator.toLowerCase()===y)},n=e.order,i=n.customer.city,[l,s]=P.useState(a()),m=y=>{s(y)},[b,u]=P.useState(null),g=hl("https://te-entrego.com/teadmin_beta/public/api/ciudades",{codigocliente:o.client_code,accesoapi:o.public_key,llaveseguridad:o.secret_key,paramb:i}),x=hl("https://te-entrego.com/teadmin_beta/public/api/ciudades",{codigocliente:o.client_code,accesoapi:o.public_key,llaveseguridad:o.secret_key,paramb:i}),w=g.data,v=x.data,E=()=>{var X;const y=(X=n==null?void 0:n.products)==null?void 0:X.reduce((k,Y)=>(k.weight+=Y.weight,Y.width>k.width&&(k.width=Y.width),Y.height>k.height&&(k.height=Y.height),Y.length>k.length&&(k.length=Y.length),k),{weight:0,width:0,height:0,length:0});return{weight:y==null?void 0:y.weight,width:y==null?void 0:y.width,height:y==null?void 0:y.height,length:y==null?void 0:y.length}},{height:f,length:c,weight:p,width:h}=E();return P.useEffect(()=>{w.length!==0&&v.length!==0&&(console.log({originLocation:w}),u({origen:w[0].codigodanelargo,destino:v[0].codigodanelargo,unidades:n.line_items[0].fulfillable_quantity,kilos:p||0,ancho:h||0,alto:f||0,largo:c||0,vlrdeclarado:n.total_price,vlrecaudo:n.sub_total_price,dest_flete:0,dest_comision:0,operador:o.operator,codigocliente:o.client_code,accesoapi:o.public_key,llaveseguridad:o.secret_key}))},[w,v]),{selectedMethod:l,customOrder:b,handleSelectedMethod:m}},nb=A.div`
  display: flex;
  justify-content: space-around;
  align-items: center;
