 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(Y,j){var E=Y.length;Y.push(j);t:for(;0<E;){var R=E-1>>>1,B=Y[R];if(0<a(B,j))Y[R]=j,Y[E]=B,E=R;else break t}}function r(Y){return Y.length===0?null:Y[0]}function o(Y){if(Y.length===0)return null;var j=Y[0],E=Y.pop();if(E!==j){Y[0]=E;t:for(var R=0,B=Y.length,Re=B>>>1;R<Re;){var Bt=2*(R+1)-1,pe=Y[Bt],Xt=Bt+1,ee=Y[Xt];if(0>a(pe,E))Xt<B&&0>a(ee,pe)?(Y[R]=ee,Y[Xt]=E,R=Xt):(Y[R]=pe,Y[Bt]=E,R=Bt);else if(Xt<B&&0>a(ee,E))Y[R]=ee,Y[Xt]=E,R=Xt;else break t}}return j}function a(Y,j){var E=Y.sortIndex-j.sortIndex;return E!==0?E:Y.id-j.id}if(typeof performance=="object"&&typeof performance.now=="function"){var n=performance;t.unstable_now=function(){return n.now()}}else{var i=Date,l=i.now();t.unstable_now=function(){return i.now()-l}}var s=[],m=[],b=1,u=null,g=3,h=!1,w=!1,k=!1,C=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(Y){for(var j=r(m);j!==null;){if(j.callback===null)o(m);else if(j.startTime<=Y)o(m),j.sortIndex=j.expirationTime,e(s,j);else break;j=r(m)}}function x(Y){if(k=!1,p(Y),!w)if(r(s)!==null)w=!0,Hr(X);else{var j=r(m);j!==null&&De(x,j.startTime-Y)}}function X(Y,j){w=!1,k&&(k=!1,f(S),S=-1),h=!0;var E=g;try{for(p(j),u=r(s);u!==null&&(!(u.expirationTime>j)||Y&&!zt());){var R=u.callback;if(typeof R=="function"){u.callback=null,g=u.priorityLevel;var B=R(u.expirationTime<=j);j=t.unstable_now(),typeof B=="function"?u.callback=B:u===r(s)&&o(s),p(j)}else o(s);u=r(s)}if(u!==null)var Re=!0;else{var Bt=r(m);Bt!==null&&De(x,Bt.startTime-j),Re=!1}return Re}finally{u=null,g=E,h=!1}}var z=!1,y=null,S=-1,M=5,N=-1;function zt(){return!(t.unstable_now()-N<M)}function Le(){if(y!==null){var Y=t.unstable_now();N=Y;var j=!0;try{j=y(!0,Y)}finally{j?Te():(z=!1,y=null)}}else z=!1}var Te;if(typeof c=="function")Te=function(){c(Le)};else if(typeof MessageChannel<"u"){var Ho=new MessageChannel,Pn=Ho.port2;Ho.port1.onmessage=Le,Te=function(){Pn.postMessage(null)}}else Te=function(){C(Le,0)};function Hr(Y){y=Y,z||(z=!0,Te())}function De(Y,j){S=C(function(){Y(t.unstable_now())},j)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(Y){Y.callback=null},t.unstable_continueExecution=function(){w||h||(w=!0,Hr(X))},t.unstable_forceFrameRate=function(Y){0>Y||125<Y?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):M=0<Y?Math.floor(1e3/Y):5},t.unstable_getCurrentPriorityLevel=function(){return g},t.unstable_getFirstCallbackNode=function(){return r(s)},t.unstable_next=function(Y){switch(g){case 1:case 2:case 3:var j=3;break;default:j=g}var E=g;g=j;try{return Y()}finally{g=E}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(Y,j){switch(Y){case 1:case 2:case 3:case 4:case 5:break;default:Y=3}var E=g;g=Y;try{return j()}finally{g=E}},t.unstable_scheduleCallback=function(Y,j,E){var R=t.unstable_now();switch(typeof E=="object"&&E!==null?(E=E.delay,E=typeof E=="number"&&0<E?R+E:R):E=R,Y){case 1:var B=-1;break;case 2:B=250;break;case 5:B=1073741823;break;case 4:B=1e4;break;default:B=5e3}return B=E+B,Y={id:b++,callback:j,priorityLevel:Y,startTime:E,expirationTime:B,sortIndex:-1},E>R?(Y.sortIndex=E,e(m,Y),r(s)===null&&Y===r(m)&&(k?(f(S),S=-1):k=!0,De(x,E-R))):(Y.sortIndex=B,e(s,Y),w||h||(w=!0,Hr(X))),Y},t.unstable_shouldYield=zt,t.unstable_wrapCallback=function(Y){var j=g;return function(){var E=g;g=j;try{return Y.apply(this,arguments)}finally{g=E}}}})(md);cd.exports=md;var df=cd.exports;/**
 * @license React
...
`,ba=A.div`
  margin-top: 21px;
`,ob=()=>{const{currentProps:t}=Vo(),e=t.shipmentData;return console.log(e),d.jsxs(rb,{children:[d.jsxs(ua,{children:[d.jsx(ga,{children:d.jsx(eb,{})}),d.jsx(Ue,{children:"en reparto"}),d.jsxs(ba,{children:[d.jsx("b",{children:"Estado:"})," ",d.jsx(Ue,{children:" en reparto"})]}),"24-04-2024"]}),d.jsx(hi,{}),d.jsxs(ua,{children:[d.jsx(ga,{children:e.estado==="TERMINAL DESTINO"||e.estado==="ENTREGADA"||e.estado==="A RECIBIR POR COORDINADORA"||e.estado==="EN TRANSPORTE"?d.jsx(bi,{}):d.jsx(ui,{})}),d.jsx(Ue,{children:"en terminal de destino"}),d.jsxs(ba,{children:[d.jsx("b",{children:"Estado:"})," ",d.jsx(Ue,{children:" en terminal de destino"})]}),"24-04-2024"]}),d.jsx(hi,{}),d.jsxs(ua,{children:[d.jsx(ga,{children:e.estado==="EN TRANSPORTE"||e.estado==="A RECIBIR POR COORDINADORA"||e.estado==="ENTREGADA"?d.jsx(bi,{}):d.jsx(ui,{})}),d.jsx(Ue,{children:"en transporte"}),d.jsxs(ba,{children:[d.jsx("b",{children:"Estado:"})," ",d.jsx(Ue,{children:" en transporte"})]}),"24-04-2024"]}),d.jsx(hi,{}),d.jsxs(ua,{children:[d.jsx(ga,{children:e.estado==="ENTREGADA"?d.jsx(bi,{}):d.jsx(ui,{})}),d.jsx(Ue,{children:"entregado"}),d.jsx(ba,{style:{color:"#60789A"},children:"Llego tu pedido"})]})]})},ab=(t,e)=>{const r=localStorage.getItem("config"),o=r&&JSON.parse(r),a=()=>{const C=o.operator;return t.findIndex(c=>c.operator.toLowerCase()===C)};console.log({currentProps:e});const n=e.order,i=n.customer.city,[l,s]=L.useState(a()),m=C=>{s(C)},b=Rm("https://te-entrego.com/teadmin_beta/public/api/ciudades",{codigocliente:o.client_code,accesoapi:o.public_key,llaveseguridad:o.secret_key,paramb:i}),u=()=>{var f;const C=(f=n==null?void 0:n.products)==null?void 0:f.reduce((c,p)=>(c.weight+=p.weight,p.width>c.width&&(c.width=p.width),p.height>c.height&&(c.height=p.height),p.length>c.length&&(c.length=p.length),c),{weight:0,width:0,height:0,length:0});return{weight:C==null?void 0:C.weight,width:C==null?void 0:C.width,height:C==null?void 0:C.height,length:C==null?void 0:C.length}},{height:g,length:h,weight:w,width:k}=u();return console.log({height:g,length:h,weight:w,width:k,handleGetOriginLocation:b}),{selectedMethod:l,handleSelectedMethod:m}},nb=A.div`
  display: flex;
  justify-content: space-around;
  align-items: center;
